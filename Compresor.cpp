// Compresor.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
{
	//check string find correct if pos+lenfind>str.size
	LZ77 LZ77Archiver;
	char *s;
	...
	if ((s = argv[1], s[1] || strpbrk(s, "DEde") == NULL)
		...
		|| (s = argv[3], (LZ77Archiver.outfile = fopen("file2.txt", "wb")) == NULL)) {
